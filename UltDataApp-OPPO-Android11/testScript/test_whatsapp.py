...
@allure.story("测试oppo_reno安卓11扫描、恢复WhatsApp附件数据")
class Test_whatsapp(AgentBaseTest):
    @allure.title("测试扫描oppo_reno安卓11设备WhatsApp附件")
