...
@allure.story("测试小米安卓12扫描、恢复WhatsApp附件数据")
class Test_whatsapp(AgentBaseTest):
    @allure.title("测试扫描小米安卓12设备WhatsApp附件")
